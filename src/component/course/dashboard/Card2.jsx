  ...
  return (
    <div className="cardNew">
      <div class="cardNew work">
        ...
        <div class="cardNew-desc">
          <div class="cardNew-header">
            <div class="cardNew-title">Python Basics</div>
            <div class="cardNew-menu">
              <div class="dot"></div>
              <div class="dot"></div>
              <div class="dot"></div>
            </div>
          </div>
          <div class="cardNew-time">12hrs</div>
          <p class="recent">Beginner</p>
          <div className="course-dashboard-progress-bar">
